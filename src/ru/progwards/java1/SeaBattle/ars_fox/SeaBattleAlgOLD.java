...
//        shootDownCell.add(new Coordinate(shipCoordinate.get(size).getX(), shipCoordinate.get(size).getY()+1));
    ...
    // 1 - проверить не сделанно ли максимальное колличество !=MISS выстрелов
    // 2 - проверить был би выстрел по этой клетке
    // 3 - выстрелить
    // 4 - если выстрел неусешный, записать все точку и идти дальше - continue - >
...
//        }
    ...
    public static void main(String[] args) {
        ...
        SeaBattle seaBattle = new SeaBattle();
        new SeaBattleAlgOLD().battleAlgorithm(seaBattle);
